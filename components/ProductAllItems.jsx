...
const ProductAllItems = React.createClass({
												...
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-12 no-pad purchaseDate3">
														<div className="icon_div">
															<span className=" threeds_max auto_marg"></span>
														</div>
														<div className="text_div">
															<span className="autoCad_txt_media prod_txt">3ds Max</span>
														</div>
													</li>
												</ul>
												}>
												...
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-11 no-pad purchaseDate3">
														<div className="icon_div">
															...
															<span className="threeInter"></span>
														</div>
														<div className="text_div">
															<span className="autoCad_txt_media new_autoCad_txt1">3ds Max Interactive</span>
											...
											header={
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-11 no-pad purchaseDate3">
														...
														<div className="text_div">
															<span className="autoCad_txt_media new_autoCad_txt1">Vault Basic - Client</span>
															<span className="autoCad_txt_media new_autoCad_txt2">English | Windows 64</span>
														</div>
													</li>
											...
											header={
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-11 no-pad purchaseDate3">
														...
														<div className="text_div">
															<span className="autoCad_txt_media new_autoCad_txt1">Vault Basic - Server</span>
															<span className="autoCad_txt_media new_autoCad_txt2">English | Windows 64</span>
														</div>
													</li>
...
module.exports = ProductAllItems