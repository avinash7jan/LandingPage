...
const ProductAllItemsTwo = React.createClass({
												...
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-12 no-pad purchaseDate3">
														<div className="icon_div">
															<span className=" advanceSteel auto_marg"></span>
														</div>
														<div className="text_div">
															<span className="autoCad_txt_media prod_txt">Advance Steel</span>
														</div>
													</li>
												</ul>
												}>
												...
												<ul className="col-xs-12 col-md-12 col-sm-12 col-lg-12 no-pad sub_ul sub_ul_hov">
													...
													<li className="col-xs-11 no-pad purchaseDate3">
														<div className="icon_div">
															...
															<span className="autoCadAS"></span>
														</div>
														<div className="text_div">
															<span className="autoCad_txt_media new_autoCad_txt1">AutoCAD with Advance Steel</span>
...
module.exports = ProductAllItemsTwo